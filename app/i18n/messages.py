...
MESSAGES: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "package.project_repo_required": "请先选择项目后再使用配置管理员进行包检索",
    ...
    "en": {
        ...
        "package.project_repo_required": "Select a project before using Configuration Manager for package search",
