# system-announcement Specification

## Purpose

Deliver a single global system announcement to authenticated users, managed by global administrators, shown once per user until acknowledged, using upgrade-safe minimal persistence.
