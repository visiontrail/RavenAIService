# bug-fix-task-registry Specification

## Purpose

Persist the bug-fix repair workflow (tasks and their merge requests) in the database so dispatch, status, and results survive restarts.
