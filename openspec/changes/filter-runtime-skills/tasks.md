...
- [x] 4.4 Report the full enabled Agent/project catalog as available and collapsed by default while keeping filtered materialization and actual invocation separate; add regressions and verify the corrected production UI.
